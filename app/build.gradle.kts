...
plugins {
    ...
    id(Config.Plugins.jetbrainsKotlinAndroid)
...
android {
    ...
    defaultConfig {
        applicationId = Config.Environments.Release.appId
        minSdk = Config.Android.androidMinSdkVersion
        targetSdk = Config.Android.androidTargetSdkVersion

        versionCode = Config.Environments.Release.appVersionCode
        versionName = Config.Environments.Release.appVersionName
